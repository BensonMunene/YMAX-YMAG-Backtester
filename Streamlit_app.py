...
#Explanation for the buttons of assets and strategies        
    ...
    if run_backtest:
        ...
        if asset_choice == "YMAX":
            try:
                all_assets = pd.read_csv(f"YMAX_VIX_VVIX_QQQ_{selected_suffix}.csv")
            except FileNotFoundError:
            ...
            try:
                all_assets = pd.read_csv(f"YMAG_VIX_VVIX_QQQ_{selected_suffix}.csv")
            except FileNotFoundError:
            ...
            try:
                df_ymax = pd.read_csv(f"YMAX_VIX_VVIX_QQQ_{selected_suffix}.csv")
                df_ymag = pd.read_csv(f"YMAG_VIX_VVIX_QQQ_{selected_suffix}.csv")
            except FileNotFoundError:
